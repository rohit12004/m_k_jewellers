...
- "Show me rings" → product_search(subCategory: "ring")
...
- "Gold necklaces under ₹30,000" → product_search(subCategory: "necklace", category: "gold", maxPrice: 30000)
- "Show me silver earrings" → product_search(subCategory: "earring", category: "silver")
`;
