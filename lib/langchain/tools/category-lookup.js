...
export const categoryLookupTool = createTool({
    ...
    description: `REQUIRED TOOL: Get a list of all available product categories from the database.

WHEN TO USE THIS TOOL:
- User asks "What categories do you have?"
- User asks "What do you sell?"
- User asks "What kind of jewelry do you have?"
- User wants to browse available product types
- User wants to explore the catalog
- User asks "Show me what you have"

DO NOT guess or make up categories. ALWAYS use this tool to get the real, current list from the database.
