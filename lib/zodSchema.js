...
export const zSchema = z.object({
  ...
  mediaId: z.string().optional(), // Optional media ID for categories/subcategories
  ...
  variants: z.array(z.object({
    ...
    hallmarkCharges: z.coerce.number().min(0, { message: "Hallmark Charges mustt be non-negative" }),
    size: z.string().optional(), // for rings
    length: z.string().optional(), // for chains/mangalsutra
  })).min(1, { message: "At least one variant is required" }),
  gender: z.enum(["MEN", "WOMEN"]),
  description: z.string().min(1),

  media: z.array(z.string()), // array of media IDs
  tryOnImage: z.union([z.string(), z.null()]).optional(), // Try-On transparent image URL
